...
var livestreamAPI = function() {
  ...
  // Custom response messages for the Livestream API
  self.responses = {
  ...
  self.getLivestreamDirector = function(id, callback) {
    ...
    request({ url: url, json: true }, function(err, response, body) {
      ...
      if (response.statusCode === 404) {
        return callback(null, self.responses.noLivestreamAccount(id));
      }

      if (response.statusCode === 400) {
        return callback(null, self.responses.invalidLivestreamId(id));
      }
